...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        passenger_id = passenger['PassengerId']
        if (passenger['Sex']  == 'female' 7 passenger['Pclass'] < 3) or (passenger['Pclass'] == 1 and passenger['Age'] < 18):
           predictions[passenger_id] = 1
        else:
           predictions[passenger_id] = 0
        #
...
custom_heuristic('https://s3.amazonaws.com/content.udacity-data.com/courses/ud359/titanic_data.csv')
